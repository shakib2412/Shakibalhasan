        ...
        <div className="animate-fade-in">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            ...
            <button
              ...
              className={`px-8 py-3 bg-white rounded-lg font-semibold hover:bg-slate-100 transition-all transform hover:scale-105 shadow-lg ${theme === 'dark' ? 'text-slate-900' : 'text-slate-900'
                }`}
            >
              Get In Touch
            </button>
